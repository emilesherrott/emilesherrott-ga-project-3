    ...
    <>
      <div className="container taras2">
        ...
        <div className="row">
          ...
          <div className="col"><div className="d-grid"><button type="button" className="btn btn-outline-primary btn-lg changingcolor1" id="changingcolor">Book your event</button></div></div>
        </div>
      </div>
