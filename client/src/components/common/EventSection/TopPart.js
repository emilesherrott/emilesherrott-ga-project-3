    ...
    <>
      <div className="container taras2">
        ...
        <div className="row">
          ...
          <Link to="/contactform"><div className="col"><div className="d-grid"><button type="button" className="btn btn-outline-primary btn-lg ">Book your event</button></div></div></Link>
        </div>
      </div>
